                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    value="{{ $discounts['discount_percent'] }}"
                                                                    >
                                                            ...
                                                            <div class="col-md-6 col-xs-6">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="inputDiscountplan" placeholder="This will show in address bar" 
                                                                        class="form-control cForm" value="{{ $discounts['discount_plan'] }}" >
                                                                        <span class="form-error"></span>
                                                                    </div>
