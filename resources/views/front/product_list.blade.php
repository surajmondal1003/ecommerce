            ...
            <div class="col-lg-10 col-md-9 col-sm-8 col-xs-12">
              <div class="lt-box">
                <div class="row">
                  ...
                  @if(!empty($search_term))
                  <p class="list-number-generate"><b>Showing <span id="listcount">{{$count}}</span> results  for "{{$search_term}}"</b></p>
                  @endif

                  @if(!empty($search_term_category))
                  <p class="list-number-generate"><b>Showing <span id="listcount">{{$count}}</span> results  for "{{$search_term_category}}"</b></p>
                  @endif
                    </div>
