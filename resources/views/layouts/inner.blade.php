                ...
                <div class="col-md-5 col-sm-6 col-xs-12">
                    <div class="rt-add">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6">
                                <div class="box">
                                    <a href="#"><span><i class="fa fa-phone" aria-hidden="true"></i></span>+ 91 33 2985 9001</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="rt-form">
                    <div class="form-block">
                        ...
                        <div class="form-group">
                            <h3>Your Name</h3>
                            <input type="text" name="popinputName" class="form-control">
                        </div>
                        <div class="form-group">
                            <h3>Email</h3>
                            <input type="text" name="popinputEmail" class="form-control">
                        </div>
                        <div class="form-group">
                            <h3>Message</h3>
                            <textarea class="form-control" name="popinputMessage"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
...
@if(@$pageBanner)
    <img src="{{asset(@$pageBanner->banner_path)}}" alt="">
    @endif
  </div>
