                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-heading border bottom">
                                        <h4 class="card-title">Edit Category Meta : {{$pagemeta['pName']}}</h4>
                                    </div>
                                    <div class="card-block">
                                        <div class="mrg-top-40">
                                            <div class="row">
                                                <div class="col-md-10 ml-auto mr-auto">
                                                    <form id="updateCategoryMetaForm">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 col-xs-6">
                                                                <div class="text-right mrg-top-5">
                                                                    <button type="submit" class="btn btn-success" id="categorymetaUpdate">Save</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </form>
